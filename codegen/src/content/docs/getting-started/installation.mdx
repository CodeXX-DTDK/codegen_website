...
<Tabs tabs={[
  ...
  <div>
    <Alert type="info">
    macOS support is coming soon. Prebuilt macOS archives aren't published yet — for now, build from source on macOS (see the project `README`), or run the Linux build in an x86-64 environment.
    </Alert>
  </div>
</Tabs>
