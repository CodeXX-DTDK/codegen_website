---
title: Supply Chain
description: How codegen's dependencies, build process, and distribution are
  structured to minimize supply chain risk.
slug: 0.0.1/trust/supply-chain
---
...
For SLSA provenance attestation, see [SLSA Compliance](/0.0.1/trust/slsa/).
