...
description: The MarkdownDocs example demonstrates fan-in grouping,
  consolidating annotated structs from any number of headers into a single API
  reference document.
slug: 0.0.1/examples/markdown-docs
---
