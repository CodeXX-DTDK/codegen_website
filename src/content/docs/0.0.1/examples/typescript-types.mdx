...
description: The built-in TypeScriptTypes rule generates TypeScript interface
  declarations from annotated C++ structs, with recursive type mapping for
  generics.
slug: 0.0.1/examples/typescript-types
---
