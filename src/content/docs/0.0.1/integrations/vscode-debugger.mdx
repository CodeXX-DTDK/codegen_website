...
description: Set breakpoints in LuaU rule scripts and step through execution in
  VS Code using the LuaU debugger over DAP.
slug: 0.0.1/integrations/vscode-debugger
---
