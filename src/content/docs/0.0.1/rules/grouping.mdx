...
description: Reference for grouping.luau scripts, input format, output contract,
  and routing patterns.
slug: 0.0.1/rules/grouping
---

import Alert from '@pelagornis/page/components/Alert.astro';

See [Grouping & Fan-in](/0.0.1/concepts/grouping/) for the conceptual overview. This page is the contract reference.
