...
slug: 0.0.1/getting-started/first-rule
---
...
<Alert type="info" title="Key Takeaways">
  ...
  * The LuaU sandbox provides `json`, the [native introspection API](/0.0.1/reference/luau-globals/), and a stdlib subset; opt-in to HTTP/env via `permissions:`.
</Alert>
