---
title: How It Works
description: A top-down walkthrough of the codegen pipeline, from annotated C++
  source to generated output files.
slug: 0.0.1/concepts/how-it-works
---
...
* The full docs are also published as a single plain-text bundle at [`/llms-full.txt`](/0.0.1/llms-full.txt) for LLM agents and offline reference.
