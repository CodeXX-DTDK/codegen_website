...
description: How preamble.luau scripts emit file headers, includes, license
  banners, and namespace wrappers — and how they're deduplicated when multiple
  rules share an output file.
slug: 0.0.1/concepts/preamble
---
